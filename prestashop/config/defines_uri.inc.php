...
if (defined('_DB_SERVER_') && defined('_PS_ADMIN_DIR_') && Configuration::get('PS_LOCALE_COUNTRY') == 'ir' && Configuration::get('PS_LOCALE_LANGUAGE') == 'fa')
{
    Tools::safeDefine('_PS_API_DOMAIN_ALT_',       'ipresta.ir/api');
    Tools::safeDefine('_PS_API_URL_ALT_',          'http://'._PS_API_DOMAIN_ALT_);

    Tools::safeDefine('_PS_TAB_MODULE_LIST_URL_',        _PS_API_URL_ALT_.'/xml/tab_modules_list.xml');
    Tools::safeDefine('_PS_API_MODULES_LIST_16_',        _PS_API_DOMAIN_ALT_.'/xml/modules_list_16.xml');
    Tools::safeDefine('_PS_CURRENCY_FEED_URL_',          _PS_API_URL_ALT_.'/xml/currencies.xml');
}
else
{
    Tools::safeDefine('_PS_API_DOMAIN_ALT_',             _PS_API_DOMAIN_);
    Tools::safeDefine('_PS_API_URL_ALT_',                _PS_API_URL_);
