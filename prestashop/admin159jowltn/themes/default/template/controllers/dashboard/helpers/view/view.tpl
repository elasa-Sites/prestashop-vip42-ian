	...
	<div class="row">
		...
		<div class="col-md-12 col-lg-2">
			<section class="dash_news panel">
				...
				<div class="text-center"><h4><a href="http://ipresta.ir/blog/" onclick="return !window.open(this.href);">{l s='Find more news'}</a></h4></div>
			</section>
			...
			<section class="dash_links panel">
				<h3><i class="icon-link"></i> {l s="Useful links"}</h3>
					<dl>
						<dt><a href="http://www.prestashop.com/doc/PS16?utm_source=back-office&amp;utm_medium=dashboard&amp;utm_campaign=back-office-{$lang_iso|upper}&amp;utm_content={if $host_mode}cloud{else}download{/if}" class="_blank">{l s="Official Documentation"}</a></dt>
						<dd>{l s="User, Developer and Designer Guides"}</dd>
					</dl>
					<dl>
						<dt><a href="http://ipresta.ir/forum?utm_source=back-office&amp;utm_medium=dashboard&amp;utm_campaign=back-office-{$lang_iso|upper}&amp;utm_content={if $host_mode}cloud{else}download{/if}" class="_blank">{l s="PrestaShop Forum"}</a></dt>
						<dd>{l s="Connect with the PrestaShop community"}</dd>
					</dl>
					<dl>
						<dt><a href="http://ipresta.ir/products?utm_source=back-office&amp;utm_medium=dashboard&amp;utm_campaign=back-office-{$lang_iso|upper}&amp;utm_content={if $host_mode}cloud{else}download{/if}" class="_blank">{l s="PrestaShop Addons"}</a></dt>
					...
					<dl>
						<dt><a href="http://ipresta.ir/contact-us?utm_source=back-office&amp;utm_medium=dashboard&amp;utm_campaign=back-office-{$lang_iso|upper}&amp;utm_content={if $host_mode}cloud{else}download{/if}" class="_blank">{l s="Contact Us!"}</a></dt>
						<dd></dd>
					</dl>
			</section>
		</div>
