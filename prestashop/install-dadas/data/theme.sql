...
UPDATE `PREFIX_configuration` SET value = 'http://ipresta.ir' WHERE name = 'BLOCKADVERT_LINK';
...
UPDATE `PREFIX_configuration` SET value = 'https://www.google.com/+PrestaShopIran' WHERE name = 'BLOCKSOCIAL_GOOGLE_PLUS';
