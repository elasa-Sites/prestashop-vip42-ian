<?php /* Smarty version Smarty-3.1.19, created on 2020-10-08 15:17:19
         compiled from "/srv/disk9/3607162/www/prestashop-fa.atwebpages.com/prestashop_1.6.1.24_rtl_1.0/prestashop/admin159jowltn/themes/default/template/controllers/dashboard/helpers/view/view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20979980345f7efc47de9ee9-05889365%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'abe24d8f3c340bc5ea3d8564c84be328e1605b44' => 
    array (
      0 => '/srv/disk9/3607162/www/prestashop-fa.atwebpages.com/prestashop_1.6.1.24_rtl_1.0/prestashop/admin159jowltn/themes/default/template/controllers/dashboard/helpers/view/view.tpl',
      1 => 1602156406,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20979980345f7efc47de9ee9-05889365',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f7efc47e8af52_73124066',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f7efc47e8af52_73124066')) {function content_5f7efc47e8af52_73124066($_smarty_tpl) {?>
<script>
...
&amp;utm_content=<?php if ($_smarty_tpl->tpl_vars['host_mode']->value) {?>cloud<?php } else { ?>download<?php }?>" class="_blank">
		...
		<div class="col-md-12 col-lg-2">
			<section class="dash_news panel">
				...
				<div class="text-center"><h4><a href="http://ipresta.ir/blog/" onclick="return !window.open(this.href);"><?php echo smartyTranslate(array('s'=>'Find more news'),$_smarty_tpl);?>
</a></h4></div>
			</section>
...
" ></iframe>
			...
			<section class="dash_links panel">
				<h3><i class="icon-link"></i> <?php echo smartyTranslate(array('s'=>"Useful links"),$_smarty_tpl);?>
					...
					<dl>
						<dt><a href="http://www.prestashop.com/doc/PS16?utm_source=back-office&amp;utm_medium=dashboard&amp;utm_campaign=back-office-<?php echo mb_strtoupper($_smarty_tpl->tpl_vars['lang_iso']->value, 'UTF-8');?>
&amp;utm_content=<?php if ($_smarty_tpl->tpl_vars['host_mode']->value) {?>cloud<?php } else { ?>download<?php }?>" class="_blank"><?php echo smartyTranslate(array('s'=>"Official Documentation"),$_smarty_tpl);?>
					...
					<dl>
						<dt><a href="http://ipresta.ir/forum?utm_source=back-office&amp;utm_medium=dashboard&amp;utm_campaign=back-office-<?php echo mb_strtoupper($_smarty_tpl->tpl_vars['lang_iso']->value, 'UTF-8');?>
&amp;utm_content=<?php if ($_smarty_tpl->tpl_vars['host_mode']->value) {?>cloud<?php } else { ?>download<?php }?>" class="_blank"><?php echo smartyTranslate(array('s'=>"PrestaShop Forum"),$_smarty_tpl);?>
					...
					<dl>
						<dt><a href="http://ipresta.ir/products?utm_source=back-office&amp;utm_medium=dashboard&amp;utm_campaign=back-office-<?php echo mb_strtoupper($_smarty_tpl->tpl_vars['lang_iso']->value, 'UTF-8');?>
...
&amp;utm_content=<?php if ($_smarty_tpl->tpl_vars['host_mode']->value) {?>cloud<?php } else { ?>download<?php }?>" class="_blank"><?php echo smartyTranslate(array('s'=>"The Forge"),$_smarty_tpl);?>
					...
					<dl>
						<dt><a href="http://ipresta.ir/contact-us?utm_source=back-office&amp;utm_medium=dashboard&amp;utm_campaign=back-office-<?php echo mb_strtoupper($_smarty_tpl->tpl_vars['lang_iso']->value, 'UTF-8');?>
