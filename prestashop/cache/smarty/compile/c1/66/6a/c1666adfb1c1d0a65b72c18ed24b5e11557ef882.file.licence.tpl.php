<?php /* Smarty version Smarty-3.1.19, created on 2020-10-08 15:41:18
         compiled from "/srv/disk9/3607162/www/prestashop-fa.atwebpages.com/prestashop_1.6.1.24_rtl_1.0/prestashop/modules/medgtranslate/views/templates/admin/licence.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14478922495f7f01e659d0d8-50821603%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c1666adfb1c1d0a65b72c18ed24b5e11557ef882' => 
    array (
      0 => '/srv/disk9/3607162/www/prestashop-fa.atwebpages.com/prestashop_1.6.1.24_rtl_1.0/prestashop/modules/medgtranslate/views/templates/admin/licence.tpl',
      1 => 1602158996,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14478922495f7f01e659d0d8-50821603',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f7f01e65b0076_40720865',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f7f01e65b0076_40720865')) {function content_5f7f01e65b0076_40720865($_smarty_tpl) {?>
<ps-panel header="<?php echo smartyTranslate(array('s'=>'License Summary','mod'=>'medgtranslate'),$_smarty_tpl);?>
">
    <ul class="license">
...
<ps-panel header="<?php echo smartyTranslate(array('s'=>'Terms and conditions','mod'=>'medgtranslate'),$_smarty_tpl);?>
">

    <ol class="terms">
        <li>
            <p><strong>Preamble:</strong> This Agreement, signed on Feb 11, 2014 [hereinafter: Effective Date] governs the relationship between You (hereinafter: Licensee) and <?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['author']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
, a duly registered company in France whose principal place of business is 20 rue des Saulniers 17230 VILLEDOUX, France (Hereinafter: Licensor). This Agreement sets the terms, rights, restrictions and obligations on using [<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
] (hereinafter: The Software) created and owned by Licensor, as detailed herein</p>
        </li>
        ...
        <li>
            ...
            <ol>
                <li>
                    ...
                    <ol>
                        <li>
                            <p>Running Software on Licensee’s Website[s] and Server[s];</p>
                        </li>

                        <li>
                            <p>Allowing 3rd Parties to run Software on Licensee’s Website[s] and Server[s];</p>
                        </li>

                        <li>
                            <p>Publishing Software’s output to Licensee and 3rd Parties;</p>
                        </li>

                        <li>
                            <p>Distribute verbatim copies of Software’s output (including compiled binaries);</p>
                        </li>

                        <li>
                            <p>Modify Software to suit Licensee’s needs and specifications.</p>
                        </li>
                    </ol>
                </li>

                <li>
                    <p><strong>Binary Restricted:</strong> Licensee may sublicense Software as a part of a larger work containing more than Software, distributed solely in Object or Binary form under a personal, non-sublicensable, limited license. Such redistribution shall be limited to unlimited codebases.</p>
                </li>
        ...
        <li>
            <p><strong>Payment:</strong> In consideration of the License granted under clause 2, Licensee shall pay Licensor a fee, via Credit-Card, PayPal or any other mean which Licensor may deem adequate. Failure to perform payment shall construe as material breach of this Agreement.</p>
        </li>
