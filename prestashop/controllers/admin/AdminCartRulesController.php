...
class AdminCartRulesControllerCore extends AdminController
{
    ...
    public function renderForm()
    {
        ...
        // Added by Danoosh - iPresta.ir - to convert date
        if (Validate::isLoadedObject($this->object) && Configuration::get('PS_LOCALE_COUNTRY') == 'ir' && $this->context->language->iso_code == 'fa')
        {
            $this->object->date_from = Pdate::pdate('Y-m-d H:i:s',strtotime($this->object->date_from));
            $this->object->date_to = Pdate::pdate('Y-m-d H:i:s',strtotime($this->object->date_to));
        }
        ...
        $this->context->smarty->assign(
            array(
                ...
                'defaultDateFrom' => local_date('Y-m-d H:00:00'),
                'defaultDateTo' => local_date('Y-m-d H:00:00', strtotime('+1 month')),
